...
<!--//   
  <td class='bgadmin'><b>${jobs.education}</b></td>    
   <td class='bgadmin'> ${jobs.responsibilities}</td>  
   <td class='bgadmin'>${jobs.qualification}</td>
   <td class='bgadmin'>${jobs.skills}</td>
 //-->  
...
<c:forEach var="states" items="${list_states}"> 
   ...
   <td class='bgadmin'><a href="#"   onclick='updateJobsConfirmationSA("${jobs.id}")'>Edit</a> </td>
   <td class='bgadmin'><a href="#"   onclick='deleteJobsConfirmationSA("${jobs.id}")'>Delete</a> </td>   
   </tr>  
   </c:forEach>  
   </table>  
   <br/> 
