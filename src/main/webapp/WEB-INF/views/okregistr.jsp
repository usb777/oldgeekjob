...
<center>
	...
	<h2><%=request.getParameter("fname") %> aka "<%=request.getParameter("login") %>"<%=request.getParameter("lname") %> </h2>

<h3>Succesfully registered, now you can Login. Please, use for it Login form.</h3>
