	...
	Cities_Dao citiesdao;
	 ...
	 @RequestMapping("/adminusers")  
	    ...
	    {  
	        ...
	        ModelAndView mav = new ModelAndView("adminka/superadmin/adminpage","list_users",list_users);
...
/*	
	...
	*/
	 ...
	 @RequestMapping("/insertUserByAdminPage")  
	    public ModelAndView insertUserByAdminPage()
	    { 		  
		     return new ModelAndView("adminka/superadmin/userInsert");  
	    } 
	 
	 @RequestMapping(value = "/insertUserbyAdmin", method=RequestMethod.POST)
		public  ModelAndView insertUserByAdmin( 
		  ...
		  if (usersdao.isValidLogin(login)) 
	    	{
			    	...
			    	mav =  new ModelAndView("adminka/superadmin/userAddPage");
		    ...
		    if( (!login.equals("")) &&(login!=null)    )
		    {
		    	...
		    	{  
		    		...
		    		mav =  new ModelAndView("adminka/superadmin/adminpage","list_users",list_users); 
	 ...
	 @RequestMapping( "/deleteUserbyAdmin")  
	    public ModelAndView deleteUserByAdmin(@RequestParam("u_id") int u_id )
	    {  
		 
		 usersdao.delete(u_id);
	        List<Users> list_users=usersdao.getUsers()  ;
	        return new ModelAndView("adminka/superadmin/adminpage","list_users",list_users); 
	 ...
	 @RequestMapping(value = "/updateUserByAdminPage", method=RequestMethod.GET)  
	    ...
	    {   
		 int role_id_user = 0;
		  ...
		  currentUser =  usersdao.getUserById(u_id);
		    ...
		    ModelAndView mav = new ModelAndView("adminka/superadmin/userUpdate","currentUser",currentUser);
	 ...
	 @RequestMapping( value = "/updateUserbyAdmin",   method=RequestMethod.POST)  
	    public ModelAndView updateUserByAdmin
	    (		
	    		@ModelAttribute("users") Users users,
	 ...
	 @RequestMapping("/adminemptype")  
	    public ModelAndView showEmploymentType()
	    {  
	        List<EmploymentType> list_emptype=emptypedao.getEmpTypes()  ;
	        return new ModelAndView("adminka/superadmin/emptype","list_emptype",list_emptype);  
	    }  
	 ...
	 @RequestMapping("/cities")  
	    ...
	    {  
	        List<Cities> list_cities=citiesdao.getCities()  ;
	        return new ModelAndView("adminka/superadmin/cities","list_cities",list_cities);  
	    } 
	 ...
	 @RequestMapping("/adminjobs")  
	    ...
	    {  
	        ...
	        ModelAndView mav = new ModelAndView("adminka/superadmin/jobs","list_jobs", list_jobs);
	 ...
	 @RequestMapping("/insertJobByAdminPage")  
	    public ModelAndView insertJobByAdminPage()
	    {   
		        
	     
		  ModelAndView mav =   new ModelAndView("adminka/superadmin/jobInsert");
	 ...
	 @RequestMapping(value = "/insertJobByAdmin",  method=RequestMethod.GET)  
	 ...
	 @RequestMapping(value = "/updateJobByAdminPage", method=RequestMethod.GET)  
	    public ModelAndView updateJobByAdminPage(HttpServletRequest request, @RequestParam("id") int id )
	    {   
		  ...
		  ModelAndView mav =  new ModelAndView("adminka/superadmin/jobUpdate","currentJob",currentJob);
		  mav.addObject("list_jobstatus",list_jobstatus);
	 ...
	 @RequestMapping( value = "/updateJobByAdmin",   method=RequestMethod.GET)  
	    public ModelAndView updateJobByAdmin
	    (		    	     	  
		...
		//    jobs.setDate_publication(date_publication); 
	     ...
	     mav = new ModelAndView("adminka/superadmin/jobs","list_jobs", list_jobs); 	  
	...
	*/
	 ...
	 @RequestMapping( "/deleteJobByAdmin")  
	    public ModelAndView deleteJobByAdmin(@RequestParam("id") int id )
	    { 
		 ModelAndView mav = null;
		 int result=-1;
	 ...
	 @RequestMapping("/statistics")  
	    ...
	    {  
	       ...
	       // List<Role_User> list_role_users=role_userdao.getRoleUsers()  ;
           int totalEmployers =  usersdao.findTotalEmployers();
           int totalJobSeekers = usersdao.findTotalJobSeekers();
           int totalJobs = jobsdao.getTotalJobs();
           int totalActiveJobs = jobsdao.getTotalActiveJobs();
	        ModelAndView mav = new ModelAndView("adminka/superadmin/statistics");
	        
	        mav.addObject("totalEmployers", totalEmployers);
	        mav.addObject("totalJobSeekers", totalJobSeekers);
	        mav.addObject("totalJobs", totalJobs);
	        mav.addObject("totalActiveJobs", totalActiveJobs);
